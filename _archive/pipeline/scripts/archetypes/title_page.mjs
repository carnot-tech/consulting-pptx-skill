...
export function html(ctx, item, n) {
  ...
  return H.coverShell(ctx, item, n,
    `<div class="big">${ctx.titleHtml(p.title || "", 18)}</div><div class="prule"></div><div class="sub">${e(p.subtitle || "")}</div>${p.lead ? `<div class="lead">${H.nl2br(e, p.lead)}</div>` : ""}`,
    "front");
}
